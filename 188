...
function termux() {
echo -e "$red [$green+$red]$Cleaning Eski Dizinler Siliniyor ...";
...
then
echo -e "$red [$green+$red]$off Araç Başarıyla Güncellendi ve 5 Saniyede Başlayacak!";
...
function linux() {
echo -e "$red [$green+$red]$off Eski Dizinler Temizleniyor ...";
